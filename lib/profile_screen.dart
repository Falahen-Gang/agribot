...
class _ProfileScreenState extends State<ProfileScreen> {
        ...
        onTap: () {
          ...
          if (task['type'] == 'npk') {
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => NPKInfoScreen(taskId: task['id']),
              ),
            );
            ...
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => WeedInfoScreen(taskId: task['id']),
              ),
            );
          } else if (task['type'] == 'disease') {
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => DiseaseInfoScreen(taskId: task['id']),
              ),
            );
          }
        },
  ...
  /// Helper method to get the appropriate color for each task status
